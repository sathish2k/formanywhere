...
import { Logo, ThemeToggle } from '@formanywhere/shared/header';
import MenuHamburgerIcon from '@formanywhere/shared/icons/svg/menu-hamburger.svg';
import MenuCloseIcon from '@formanywhere/shared/icons/svg/menu-close.svg';
