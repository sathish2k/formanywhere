...
import { getIconPath } from '@formanywhere/shared/utils';
...
export const PricingCard: Component<PricingCardProps> = (props) => {
    ...
    return (
        <div
            class={props.class || ''}
            style={{ height: '100%', position: 'relative', ...(props.plan.popular ? { 'padding-top': '1rem' } : {}) }}
        >
            {/* Popular badge */}
                ...
                >
                    <span
                        style={{
                            ...
                            color: 'var(--m3-color-tertiary-dark)',
                            'font-size': '14px',
                            'font-weight': '700',
            ...
            <div
                style={{
                    ...
                    background: props.plan.gradient
                        ? 'linear-gradient(135deg, var(--m3-color-secondary), color-mix(in srgb, var(--m3-color-secondary-dark) 90%, black))'
                        : 'var(--m3-color-surface)',
                    color: props.plan.gradient ? 'var(--m3-color-on-secondary)' : 'inherit',
                    border: props.plan.popular
                        ? '2px solid var(--m3-color-tertiary)'
                ...
                <Stack direction="column" gap="md">
                    ...
                    <div>
                        <Typography
                            ...
                            style={{
                                'font-weight': '700',
                                'margin-bottom': '4px',
                                color: props.plan.gradient ? 'var(--m3-color-on-secondary)' : 'var(--m3-color-on-surface)',
                            }}
                        >
                            {props.plan.name}
                        </Typography>
                        <Typography
                            ...
                            style={{
                                color: props.plan.gradient
                                    ? 'color-mix(in srgb, var(--m3-color-on-secondary) 90%, transparent)'
                    ...
                    <div style={{ display: 'flex', 'align-items': 'baseline', gap: '8px' }}>
                        ...
                        <Typography
                            ...
                            style={{
                                color: props.plan.gradient
                                    ? 'color-mix(in srgb, var(--m3-color-on-secondary) 80%, transparent)'
                                    : 'var(--m3-color-on-surface-variant)',
                            }}
                        >
                            {priceLabel()}
                    ...
                    <Button
                        ...
                        style={{
                            ...
                            background: props.plan.gradient
                                ? 'transparent'
                                : 'linear-gradient(135deg, var(--m3-color-tertiary), color-mix(in srgb, var(--m3-color-tertiary-dark) 85%, black))',
                            color: props.plan.gradient ? 'var(--m3-color-on-secondary)' : 'var(--m3-color-on-tertiary)',
                            border: props.plan.gradient ? '2px solid var(--m3-color-on-secondary)' : 'none',
                            'font-weight': '600',
                        }}
                    >
                        {props.plan.cta}
