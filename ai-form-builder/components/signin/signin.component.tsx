/**
 * SignIn Component
 * Combined signin/signup form with toggle, stats on left branding panel
 */
...
import { type SignInFormData, signinDefaults, signinSchema } from './signin.configuration';
import { signInWithEmail, signInWithGithub, signInWithGoogle } from './signin.datasource';
    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', bgcolor: 'white' }}>
      ...
      >
        ...
        <Box sx={{ position: 'relative', zIndex: 1, maxWidth: 500 }}>
          ...
          <Typography
            variant="body1"
            sx={{ color: 'rgba(255, 255, 255, 0.9)', mb: 4, fontSize: '1.125rem', lineHeight: 1.7 }}
          >
        ...
        <Box sx={{ width: '100%', maxWidth: 440 }}>
            ...
            >
              <Box
                sx={{
                  ...
                  alignItems: 'center',
                  justifyContent: 'center',
                  boxShadow: `0px 8px 16px 0px ${theme.palette.primary.main}40`,
                }}
              >
                <Sparkles size={22} color="white" strokeWidth={2.5} />
              </Box>
          ...
          <Box sx={{ mb: 4 }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ fontSize: '1rem' }}>
              {isSignUp
                ? 'Get started with FormBuilder AI for free'
            ...
            <Stack spacing={3}>
              ...
              <Button
                ...
                sx={{
                  ...
                  boxShadow: `0px 8px 16px 0px ${theme.palette.primary.main}40`,
                  '&:hover': {
                    boxShadow: `0px 12px 24px 0px ${theme.palette.primary.main}50`,
                  },
                }}
              >
