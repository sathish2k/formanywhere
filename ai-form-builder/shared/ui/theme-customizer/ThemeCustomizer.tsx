...
const themes = [
  ...
  },
  {
    ...
    color: '#BF5AF2',
    secondary: '#1A1A1A',
    gradient: 'linear-gradient(135deg, #BF5AF2 0%, #D78EFF 100%)',
  },
  {
    name: 'Blue',
    color: '#007AFF',
    secondary: '#1A1A1A',
    gradient: 'linear-gradient(135deg, #007AFF 0%, #3FA1FF 100%)',
  },
  {
    name: 'Green',
    color: '#34C759',
    secondary: '#1A1A1A',
    gradient: 'linear-gradient(135deg, #34C759 0%, #5FD682 100%)',
  },
  {
    name: 'Orange',
    color: '#FF9500',
  ...
  },
  {
    ...
    color: '#FF2D55',
    secondary: '#1A1A1A',
    gradient: 'linear-gradient(135deg, #FF2D55 0%, #FF5B7D 100%)',
  },
];
