/**
 * Radio Properties - Similar to Select with options
 */
...
type RadioPropertiesFormData = z.infer<typeof radioPropertiesSchema>;
...
export function RadioProperties({ element, onUpdate }: RadioPropertiesProps) {
  const { control, watch, reset, register } = useForm<RadioPropertiesFormData>({
